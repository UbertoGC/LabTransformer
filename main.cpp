...
int main(){
    ...
    int m_entradas = 384;
    int v_size = 256;
    //{dimension del modelo, maxima entrada, tamaño del vocabulario}
    int config_transformer[3] = {d_modelo, m_entradas, v_size};
    //{numero de bloques, numero de cabezas, dimension del feedforward}
    int config_decoder[3] = {2, 2, 32};
    int config_encoder[3] = {1, 2, 32};
    ...
    Transformer<Mat> transformer(conversor_img_vec, config_transformer, config_decoder, config_encoder);
